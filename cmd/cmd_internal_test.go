...
func testdataExpectedJUnitXML() string {
  ...
  <testcase name="Fail: expected 0, got 3">
    <failure>expected exit code 0, got 3</failure>
    <system-out># Step 1:&#xA;+ exit 3&#xA;</system-out>
  </testcase>
  <testcase name="Fail: expected 1, got 0">
  ...
  <testcase name="Success: expected 0, got 0">
    <system-out># Step 1:&#xA;+ exit 0&#xA;</system-out>
  </testcase>
  <testcase name="Success: normalise info texts">
